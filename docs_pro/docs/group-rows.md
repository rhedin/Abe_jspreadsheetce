...
| openRowGroup(number\|Number[])  | Open a group of rows.<br/>`openRowGroup(rowNumber?: Number\|Number[]) : void`                           |
| closeRowGroup(number\|Number[]) | Close a group of rows.<br/>`closeRowGroup(rowNumber?: Number\|Number[]) : void`                         |
