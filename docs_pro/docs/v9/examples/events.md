...
description: This section provides more demonstrations of the JS spreadsheet events and the global event dispatcher. An integration example with data synchronization using events.
