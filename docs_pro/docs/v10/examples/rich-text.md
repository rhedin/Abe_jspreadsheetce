title: Custom Cell Editor in Jspreadsheet - Empower Cells with Rich Text and HTML Formatting
keywords: Jspreadsheet, javascript, plugins, spreadsheet, rich text editor, text formatting
description: Enable users to add formatted text into spreadsheet cells using a mini JavaScript HTML editor with the Rich Text Editor column type in Jspreadsheet.

# Data Grid HTML Editor
