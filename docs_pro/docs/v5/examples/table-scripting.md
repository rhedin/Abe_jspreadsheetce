title: JavaScript Spreadsheet Customizations
keywords: Jspreadsheet, javascript, excel-like, spreadsheet, table scripting
...
Customize the data grid behavior via javascript.
