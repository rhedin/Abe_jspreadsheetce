title: ChartJS Integration with Jspreadsheet Version 5
keywords: Jspreadsheet, javascript, highcharts, charts
description: Integrating Jspreadsheet Pro version 5 with ChartJS example.
...
To learn much more about chartjs extensions for Jspreadsheet:
  ...
  * [Chartjs extension for Jspreadsheet](/docs/v5/charts "Spreadsheet with charts")
  * [ChartJS example](/docs/v5/examples/spreadsheet-with-charts "Spreadsheet with charts")
